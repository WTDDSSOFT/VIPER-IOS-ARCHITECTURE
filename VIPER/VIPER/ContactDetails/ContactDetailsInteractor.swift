...
final class ContactDetailsInteractor: ContactDetailsInteractorInput {
   ...
   private let dict: [ String : ContactDetailsEntity] = [
      "Buffalo": .init(name: "Buffalo", image: "buffalo", number: "+1 3907303", from: "School"),
      "Cheetah": .init(name: "Cheetah", image: "cheetah", number: "+1 3920", from: "My cousin"),
